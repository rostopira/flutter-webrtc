...
public final class FixedHardwareVideoEncoderFactory implements VideoEncoderFactory {
    private static final String TAG = "FixedHardwareVideoEncoderFactory";
    ...
    /**
     * Creates a FixedHardwareVideoEncoderFactory that supports surface texture encoding.
     *
     ...
     */
    public FixedHardwareVideoEncoderFactory(
     ...
     */
    public FixedHardwareVideoEncoderFactory(EglBase.Context sharedContext, boolean enableIntelVp8Encoder,
    ...
    @Deprecated
    public FixedHardwareVideoEncoderFactory(boolean enableIntelVp8Encoder, boolean enableH264HighProfile) {
    ...
    public VideoEncoder createEncoder(VideoCodecInfo input) {
        ...
        return new FixedHardwareVideoEncoder(new MediaCodecWrapperFactoryImpl(), codecName, type,
    ...
    private BitrateAdjuster createBitrateAdjuster(VideoCodecType type, String codecName) {
        ...
        Log.wtf("WTF", "Created bitrate adjuster");
        // Other codecs don't need bitrate adjustment.
        final BaseBitrateAdjuster bba = new BaseBitrateAdjuster();
        bba.setTargets(2900 * 1024 * 8, 30);
        return bba;
    }
